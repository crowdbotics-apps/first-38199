"""
Django settings for first_38199 project.
...
WSGI_APPLICATION = 'first_38199.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "first_38199 API",
    "DESCRIPTION": "API documentation for first_38199 App",
    "VERSION": "v1",
}
